 ...
 */
final readonly class Test_Triggered_Phpunit_Error_Subscriber extends Subscriber implements Phpunit_Error_Triggered_Subscriber
{
    public function notify(Phpunit_Error_Triggered $event): void
    {
        $this->collector()->test_triggered_phpunit_error($event);
    }
}