 ...
 */
final readonly class Test_Considered_Risky_Subscriber extends Subscriber implements Considered_Risky_Subscriber
{
    public function notify(Considered_Risky $event): void
    {
        $this->collector()->test_considered_risky($event);
    }
}