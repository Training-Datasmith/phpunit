 ...
 */
final readonly class Test_Triggered_Phpunit_Warning_Subscriber extends Subscriber implements Phpunit_Warning_Triggered_Subscriber
{
    public function notify(Phpunit_Warning_Triggered $event): void
    {
        $this->collector()->test_triggered_phpunit_warning($event);
    }
}