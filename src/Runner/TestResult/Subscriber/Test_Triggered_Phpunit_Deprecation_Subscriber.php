 ...
 */
final readonly class Test_Triggered_Phpunit_Deprecation_Subscriber extends Subscriber implements Phpunit_Deprecation_Triggered_Subscriber
{
    public function notify(Phpunit_Deprecation_Triggered $event): void
    {
        $this->collector()->test_triggered_phpunit_deprecation($event);
    }
}