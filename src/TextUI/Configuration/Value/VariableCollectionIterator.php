 ...
 */
final class Variable_Collection_Iterator implements Iterator
{
    /**
     * @var list<Variable>
     */
    ...
    public function __construct(Variable_Collection $variables)
    {
        $this->variables = $variables->as_array();
    }
