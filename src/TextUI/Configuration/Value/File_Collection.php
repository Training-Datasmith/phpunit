 ...
 */
final readonly class File_Collection implements Countable, IteratorAggregate
{
    /**
     * @var list<File>
     */
    ...
    public function getIterator(): File_Collection_Iterator
    {
        return new File_Collection_Iterator($this);
    }
}