 ...
 */
final class Constant_Collection_Iterator implements Iterator
{
    /**
     * @var list<Constant>
     */
    ...
    public function __construct(Constant_Collection $constants)
    {
        $this->constants = $constants->as_array();
    }
