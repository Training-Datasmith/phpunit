...
{
    public function __construct(private Telemetry\Info $telemetry_info, private Test_Suite $test_suite, private string $message)
    {
    }
    ...
    {
        return sprintf('Test Suite Skipped (%s, %s)', $this->test_suite->name(), $this->message);
    }
}