 ...
 */
final readonly class Execution_Started implements Event
{
    ...
    {
        return sprintf('Test Runner Execution Started (%d test%s)', $this->test_suite->count(), $this->test_suite->count() !== 1 ? 's' : '');
    }
}