...
##teamcity[testFailed name='testNestedExceptions' message='Exception: One' details='%s%etests%e_files%eExceptionStackTest.php:38|n|nCaused by|nInvalidArgumentException: Two|n|n%s%etests%e_files%eExceptionStackTest.php:37|n|nCaused by|nException: Three|n|n%s%etests%e_files%eExceptionStackTest.php:36|n' duration='%d' flowId='%d']
